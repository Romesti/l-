...
namespace CarryAshe
{
    internal static class ItemManager
    {
        ...
        internal class ItemType
        {
            ...
            public static ItemType Slow = new ItemType
            {
                ...
                IsUsableNow = (item) =>
                {
                    ...
                    return target.IsValid<Obj_AI_Hero>()
                        && !((Obj_AI_Hero)target).IsCharmed
                        && !((Obj_AI_Hero)target).IsRooted
                        && !((Obj_AI_Hero)target).IsStunned;
                },
        ...
        static ItemManager()
        {
            ...
            Obj_AI_Hero.OnPlaceItemInSlot += (hero, args) =>
            {
